 ...
 * -------------------------------------------------------------
 */
none bErrorPrint(str fmt, ...);
none displayBuffer(Buffer* ptr_Buffer);
long getFileSize(str fname);
int isNumber(const str ns);
none startReader(str, str, sofia_char, int, int);
...
************************************************************
*/
none startReader(str program, str input, sofia_char mode, int size, int increment) {
