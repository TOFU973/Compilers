...
#define FLAG_END 0b00001000 // 0x08
/* TO_DO: BIT 2: REL = Rellocation memory flag */
#define FLAG_REL 0b00000100 // 0x04
/* TO_DO: BIT 1: EMP = Buffer empty flag */
#define FLAG_EMP 0b00000010 // or you can use hex rep 0x02
/* TO_DO: BIT 0: FUL = Buffer full flag */
#define FLAG_FUL 0b00000000 // 0x00
...
boln		readerClear		    (BufferPointer const);
boln		readerFree		    (BufferPointer const);
boln		readerIsFull		(BufferPointer const);
boln		readerIsEmpty		(BufferPointer const);
boln		readerSetMark		(BufferPointer const, int);
int		readerPrint		    (BufferPointer const);
int		readerLoad			(BufferPointer const, FILE* const);
boln		readerRecover		(BufferPointer const);
boln		readerRetract		(BufferPointer const);
boln		readerRestore		(BufferPointer const);
/* Getters */
...
none		readerPrintStat		(BufferPointer const);
